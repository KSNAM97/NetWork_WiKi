...
| # | 페이지 | 내용 |
|---|--------|------|
| 1 | [Hub · Switch · Router](Hub-Switch-Router) | Layer별 대표 장비 개념 |
| 2 | [Switch 동작원리](Switch-동작원리) | Flooding, Learning, Forwarding, Filtering, Aging |
| 3 | [VLAN](VLAN) | VLAN 개념, 생성/수정/삭제 |
| 4 | [Switchport Mode](Switchport-Mode) | Access, Trunk, Dynamic 모드 |
| 5 | [Trunk](Trunk) | IEEE 802.1Q, ISL, Native VLAN, 고급 설정 |
| 6 | [Inter-VLAN](Inter-VLAN) | Sub-interface를 활용한 VLAN 간 라우팅 |
| 7 | [IP Header](IP-Header) | IP Header 구조 및 필드 설명 |
| 8 | [TCP · UDP](TCP-UDP) | 3-way Handshake, TCP/UDP 헤더 |
| 9 | [IPv4 주소](IPv4-Address) | IP 주소 구조, 클래스, 서브넷 |
